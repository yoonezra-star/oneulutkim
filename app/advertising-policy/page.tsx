...
export default function AdvertisingPolicyPage() {
  return (
    <InfoPage title="광고정책" eyebrow="Advertising Policy">
      ...
      <h2>광고와 콘텐츠의 분리</h2>
      <p>
        광고는 독자가 본문과 구분할 수 있는 위치와 맥락에서만 운영합니다. 광고를 클릭하도록
        유도하는 문구, 광고처럼 보이지 않는 광고 배치, 콘텐츠 제목이나 목록 항목으로 오인될 수
        있는 광고 구성은 사용하지 않습니다. 광고 수익은 사이트 운영을 보조하기 위한 수단이며,
        개별 글의 결론이나 게시 여부를 결정하는 기준이 아닙니다.
      </p>

      <h2>광고 검토와 조정</h2>
      <p>
        사이트 이용을 방해하거나 부적절한 광고가 확인되면 위치, 형식, 게재 방식을 조정합니다.
        특히 모바일 화면에서 광고가 본문을 가리거나 실수 클릭을 유발하지 않는지 정기적으로
        확인하며, 정책 위반 가능성이 있는 광고는 가능한 범위에서 차단 또는 신고합니다.
      </p>
    </InfoPage>
  );
}
