import { publishedScheduledPosts } from "./published-scheduled-posts";
...
const scheduledPosts: Post[] = [
  ...
  {
    id: 26081901,
    slug: "bookstore-receipt-bookmark",
    category: "culture",
    title: "서점 영수증을 책갈피로 쓰게 되는 이유",
    author: "책장정리인",
    date: "26/08/19 09:00",
    views: 0,
    recommends: 0,
    comments: 0,
    label: "예약",
    summary: "책 사이에 꽂힌 영수증은 읽던 위치와 책을 산 날의 기분을 함께 기억합니다.",
    body: [
  ...
  {
    id: 26082201,
    slug: "desk-dust-line-truth",
    category: "office",
    title: "책상 위 물건을 옮겼을 때 드러나는 먼지선의 진실",
    author: "책상정비팀",
    date: "26/08/22 09:00",
    views: 0,
    recommends: 0,
    comments: 0,
    label: "예약",
    summary: "오래 놓인 물건 아래의 먼지선은 책상 생활의 시간을 너무 정직하게 보여 줍니다.",
    body: [
...
const preparedPosts: Post[] = [...publishedScheduledPosts, ...expandedPosts, ...originalPosts].map((post) => {
...
export const posts: Post[] = preparedPosts;
